...
#define GCKMediaQueueItemClass NSClassFromString(@"GCKMediaQueueItem")
#endif
 ...
 */
#ifdef USE_CAST_DYNAMIC_FRAMEWORK
#define kGCKMediaQueueInvalidItemID GCK_EXTERN_NSINTEGER(kGCKMediaQueueInvalidItemID)
#else
...
- (instancetype)initWithMediaInformation:(GCKMediaInformation *)mediaInformation
                        ...
                        playbackDuration:(NSTimeInterval)playbackDuration
                             preloadTime:(NSTimeInterval)preloadTime
                          activeTrackIDs:(NSArray<NSNumber *> * GCK_NULLABLE_TYPE)activeTrackIDs
                              customData:(id GCK_NULLABLE_TYPE)customData /*NS_DESIGNATED_INITIALIZER*/;
