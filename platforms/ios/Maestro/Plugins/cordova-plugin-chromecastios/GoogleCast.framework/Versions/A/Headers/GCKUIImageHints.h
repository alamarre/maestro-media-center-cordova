...
#define GCKUIImageHintsClass NSClassFromString(@"GCKUIImageHints")
#endif
 ...
 * compliant.
 */
@property(nonatomic, copy, readonly, GCK_NULLABLE) NSObject<NSCoding> *customData;
...
- (instancetype)initWithImageType:(GCKMediaMetadataImageType)imageType
                       ...
                       customData:(NSObject<NSCoding> * GCK_NULLABLE_TYPE)customData;
