...
#define GCKCastSessionClass NSClassFromString(@"GCKCastSession")
#endif
 ...
 * not directly call the session lifecycle methods such as @ref start or @ref endAndStopCasting:.
 *
 * @since 3.0
 */
GCK_EXPORT
...
/**
 * The GCKRemoteMediaClient object that can be used to control media playback in the currently
 * active session, if the session supports the media namespace; otherwise <code>nil</code>.
 */
@property(nonatomic, strong, readonly) GCKRemoteMediaClient *remoteMediaClient;
...
- (instancetype)initWithDevice:(GCKDevice *)device
                   ...
                   castOptions:(GCKCastOptions *)castOptions NS_DESIGNATED_INITIALIZER;
