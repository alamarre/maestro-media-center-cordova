...
/**
 * The Cast session that is associated with this controller.
 */
@property(nonatomic, strong, readonly, GCK_NULLABLE) GCKCastSession *session;
...
/**
 * An image view for displaying the currently loaded media's thumbnail image.
 */
@property(nonatomic, weak, readonly, GCK_NULLABLE) UIImageView *thumbnailImageView;

/**
 * An image hints object to describe the image shown in thumbnailImageView.
 */
@property(nonatomic, strong, readonly, GCK_NULLABLE) GCKUIImageHints *thumbnailImageHints;
...
/**
 * An image view for displaying the next queued media's thumbnail image.
 */
@property(nonatomic, weak, readonly, GCK_NULLABLE) UIImageView *nextItemThumbnailImageView;

/**
 * An image hints object to describe the image shown in nextItemThumbnailImageView.
 */
@property(nonatomic, strong, readonly, GCK_NULLABLE) GCKUIImageHints *nextItemThumbnailImageHints;

/**
 * A label view for displaying the title of the next queued media.
 */
@property(nonatomic, weak, readwrite, GCK_NULLABLE) UILabel *nextItemTitleLabel;

/**
 * A label view for displaying the subtitle of the next queued media.
 */
@property(nonatomic, weak, readwrite, GCK_NULLABLE) UILabel *nextItemSmartSubtitleLabel;
