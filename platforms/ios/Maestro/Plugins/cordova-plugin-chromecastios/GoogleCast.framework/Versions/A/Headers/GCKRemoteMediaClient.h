...
#ifdef USE_CAST_DYNAMIC_FRAMEWORK
#define kGCKKeyConnected GCK_EXTERN_NSSTRING(kGCKKeyConnected)
#else
GCK_EXTERN NSString *const kGCKKeyConnected;
#endif
 ...
 */
- (void)remoteMediaClient:(GCKRemoteMediaClient *)client
    didUpdateMediaMetadata:(GCKMediaMetadata *)mediaMetadata;
